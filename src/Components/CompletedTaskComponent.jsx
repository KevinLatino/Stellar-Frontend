        ...
        <div className="relative bg-white shadow-md rounded-[0.6rem] w-[18rem] h-[7rem] overflow-hidden flex" style={gradientBorderStyle}>
            ...
            <div className="flex flex-col justify-between h-full pl-4 pr-3 py-3 flex-grow">
                <div className="flex justify-between items-start mb-1">
                    <h2 className="text-lg font-bold text-stellar-blue font-raleway truncate pr-2">Yo decido</h2>
                </div>
                <p className="text-stellar-grey font-raleway text-sm flex-grow overflow-hidden">Debo terminar la presentación de yo decido hasta la lección 8</p>
