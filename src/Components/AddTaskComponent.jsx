            ...
            {isPopupOpen && (
                <div className="animate__animated animate__fadeIn fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-20">
                    ...
                    <div className="flex flex-col justify-center items-center animate__animated animate__bounceInDown bg-white p-6 rounded-lg w-[32rem] max-w-full text-center">
                        ...
                        <h2 className="text-2xl mb-4 font-raleway border-b-[0.1rem] border-[#4461F2]">¡Agrega una nueva tarea!</h2>
                        ...
                        <div className="relative mb-4 w-full max-w-md">
                            ...
                            <input
                                ...
                                className="bg-[#E0E4EE] text-gray-800 py-2 pl-12 w-full rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                        </div>
                        ...
                        <div className='flex gap-4'>
                            <button
                                ...
                                className="bg-light-green text-white px-4 py-2 rounded-xl"
                            >
                                Crear tarea
                            </button>
